...
namespace Catopia.GasStation
{
    ...
    public class ControllerUseObject : MyUseObjectBase
    {
        ...
        public ControllerUseObject(IMyEntity owner, string dummyName, IMyModelDummy dummyData, uint shapeKey) : base(owner, dummyData)
        {
